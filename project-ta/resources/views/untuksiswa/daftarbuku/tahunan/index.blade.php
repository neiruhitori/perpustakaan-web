...
<body>
    <div class="container-fluid event py-5">
        <div class="container py-5">
            <div class="text-center mx-auto mb-5" style="max-width: 800px;">
                <h1 class="text-uppercase text-primary">Buku Tahunan</h1>
                <h3 class="mb-0">Rekomendasi</h3>
            </div>
            <div class="event-carousel owl-carousel">
                @foreach ($events->slice(0, 4) as $book)
                    <div class="event-item">
                        <img src="{{ asset('gambarbukutahunan/' . $book->foto) }}" class="img-fluid w-100"
                            alt="Image">
                        <div class="event-content p-4">
                            ...
                            <a class="btn-hover-bg btn btn-primary text-white py-2 px-4"
                                href="{{ route('untuksiswa.daftarbuku.tahunan.lihat', $book->id) }}">Lihat</a>
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <div class="container-fluid blog py-5 mb-5">
        <div class="container py-5">
            ...
            <form action="{{ route('untuksiswa.daftarbuku.tahunan.search') }}" method="GET">
                            ...
                            <div class="blog-item">
                                <div class="blog-img">
                                    ...
                                    <div class="blog-info">
                                        ...
                                        <a href="{{ asset('gambarbukutahunan/' . $book->foto) }}" class="text-white">0 <i
                                                class="fa fa-comment"></i></a>
                                    </div> --}}
                                    </div>
                                    <div class="search-icon">
                                        <a href="{{ asset('gambarbukutahunan/' . $book->foto) }}" data-lightbox="Blog-1"
                                            class="my-auto"><i
