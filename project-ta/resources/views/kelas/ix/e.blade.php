        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kelas IX E</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                                <li class="breadcrumb-item active">Kelas IX E</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    <form action="{{ route('ixe.search') }}" method="GET">
                    ...
                    <a href="{{ route('ixe.pdf') }}" class="btn btn-danger mb-3 breadcrumb float-sm-right">
                        ...
                        <tbody>
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Kelas IX E belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
