        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kelas IX G</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/dashboard">Beranda</a></li>
                                <li class="breadcrumb-item active">Kelas IX G</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    <form action="{{ route('ixg.search') }}" method="GET">
                    ...
                    <a href="{{ route('ixg.pdf') }}" class="btn btn-danger mb-3 breadcrumb float-sm-right">
                        ...
                        <tbody>
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Kelas IX G belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
