        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kelas VIII G</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                                <li class="breadcrumb-item active">Kelas VIII G</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    <form action="{{ route('viiig.search') }}" method="GET">
                    ...
                    <a href="{{ route('viiig.pdf') }}" class="btn btn-danger mb-3 breadcrumb float-sm-right">
                        ...
                        <tbody>
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Kelas VIII G belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
