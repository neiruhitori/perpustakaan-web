        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kelas VIII B</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                                <li class="breadcrumb-item active">Kelas VIII B</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    <form action="{{ route('viiib.search') }}" method="GET">
                    ...
                    <a href="{{ route('viiib.pdf') }}" class="btn btn-danger mb-3 breadcrumb float-sm-right">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @forelse ($viiib as $key => $k)
                                @if ($viiib->count() > 'VIII B')
                                    <tr>
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Kelas VIII B belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
