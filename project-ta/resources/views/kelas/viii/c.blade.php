        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kelas VIII C</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                                <li class="breadcrumb-item active">Kelas VIII C</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    <form action="{{ route('viiic.search') }}" method="GET">
                    ...
                    <a href="{{ route('viiic.pdf') }}" class="btn btn-danger mb-3 breadcrumb float-sm-right">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @forelse ($viiic as $key => $k)
                                @if ($viiic->count() > 'VIII C')
                                    <tr>
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Kelas VIII C belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
