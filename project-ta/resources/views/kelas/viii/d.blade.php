        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Kelas VIII D</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/dashboard">Home</a></li>
                                <li class="breadcrumb-item active">Kelas VIII D</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                    <form action="{{ route('viiid.search') }}" method="GET">
                    ...
                    <a href="{{ route('viiid.pdf') }}" class="btn btn-danger mb-3 breadcrumb float-sm-right">
                ...
                <div class="card-body">
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            @forelse ($viiid as $key => $k)
                                @if ($viiid->count() > 'VIII D')
                                    <tr>
                            ...
                            @empty
                                <div class="alert alert-danger">
                                    Data Kelas VIII D belum Tersedia.
                                </div>
                            @endforelse
                        </tbody>
                    </table>
