...
@section('contents')
    <div class="content-wrapper">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            ...
                            <li class="breadcrumb-item active"><a href="/buku">Buku Tahunan</a></li>
        ...
        <form method="post" enctype="multipart/form-data" id="profile_setup_frm"
            action="{{ route('buku.createkodebukutahunanstore') }}">
            @csrf
            <div class="row">
                <div class="col-md-12 border-right">
                    <div class="p-3 py-5">
                        <h4 class="text-left">Buat Kode Buku Tahunan</h4>
                        <div class="row mt-2">
                            <table class="table table-bordered" id="table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <select id="bukucrud_id" name="bukucrud_id[]"
        ...
        <script>
            ...
            function addRow() {
                ...
                newRow.innerHTML = `
                    <td>
                        <select id="bukucrud_id" name="bukucrud_id[]" class="form-control tag-select">
                            <option selected disabled>Pilih buku</option>
                            @foreach ($buku as $buk)
